    ...
    <div>
      ...
      <div class="hello">
        <div class="d-flex justify-content-center align-items-center mb-3">
          <h1 class="text-center">Appointment Management
            <button class="btn btn-info btn-sm ml-3" @click="addAppointment()">Add an Appointment</button>
          </h1>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-center">-- Appointments List --</h5>
                <div v-for="appointment in appointments" :key="appointment.id">
                  <div class="card mb-2">
                    <div class="card-body">
                      <h6 class="card-subtitle mb-2 text-muted">Appointment ID: {{ appointment.id }}</h6>
                      <p class="card-text">Patient: {{ appointment.PatientName }}</p>
                      <p class="card-text">Doctor: {{ appointment.DoctorName }}</p>
                      <p class="card-text">Date / Time: {{ formatDateTime(appointment.time) }}</p>
                      <p class="card-text">Status: {{ appointment.status }}</p>
                      <div v-if="isAdmin || isDoctor" class="d-flex justify-content-center">
                      ...
                      <div v-if="isAdmin" class="d-flex justify-content-center">
                        <button class="btn btn-danger btn-sm m-1" @click="deleteAppointment(appointment)">Delete</button>
                      </div>
                    </div>
                  </div>
                </div>
